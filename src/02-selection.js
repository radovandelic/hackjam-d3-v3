...
export const querySelectDivWithDemoSelectionId = () => {
  return document.querySelector('#demo-selection');
};
...
export const querySelectFirstPElement = () => {
  return document.querySelector('#demo-selection').querySelector('p');
};
...
export const selectDivWithDemoSelectionId = d3 => {
  return d3.select('#demo-selection');
};
...
export const selectFirstPElement = d3 => {
  return d3.select('#demo-selection > p');
};
